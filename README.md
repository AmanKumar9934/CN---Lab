...
Title: Simulation of CS/CD (Carrier Sense Multiple Access with Collision Detection) using Hub in Cisco Packet Tracer
...
CS/CD (Carrier Sense Multiple Access with Collision Detection) is a network protocol used in Ethernet networks where multiple devices share the same communication medium.
...
«📌 Upload your actual Packet Tracer screenshot as "topology.png"»
